...
#export DOCKER_IMAGE_TAG=amd64-2.0.0
export DOCKER_DEVMODE=true
...
then
    ...
    docker exec -e "CORE_PEER_ADDRESS=peer1.magnetocorp.example.com:7051" -e "CORE_PEER_LOCALMSPID=magnetocorpMSP" -e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/magnetocorp.example.com/users/Admin@magnetocorp.example.com/msp" -e "CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/magnetocorp.example.com/peers/peer1.magnetocorp.example.com/tls/ca.crt" cli peer channel create -o orderer1.magnetocorp.example.com:7050 -c ${CHANNEL_NAME} -f ./channel-artifacts/channel.tx --tls true --cafile $ORDERER_CA

    echo -----------------------------------------------------
    echo Join MagnetoCorp Peer to the channel.
    docker exec -e "CORE_PEER_ADDRESS=peer1.magnetocorp.example.com:7051" -e "CORE_PEER_LOCALMSPID=magnetocorpMSP" -e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/magnetocorp.example.com/users/Admin@magnetocorp.example.com/msp"  -e "CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/magnetocorp.example.com/peers/peer1.magnetocorp.example.com/tls/ca.crt" cli peer channel join -b ${CHANNEL_NAME}.block 

    echo -----------------------------------------------------
    echo Update channel with MagnetoCorp information.
    docker exec -e "CORE_PEER_ADDRESS=peer1.magnetocorp.example.com:7051" -e "CORE_PEER_LOCALMSPID=magnetocorpMSP" -e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/magnetocorp.example.com/users/Admin@magnetocorp.example.com/msp" -e "CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/magnetocorp.example.com/peers/peer1.magnetocorp.example.com/tls/ca.crt" cli peer channel update -o orderer1.magnetocorp.example.com:7050 -c papernet -f ./channel-artifacts/magnetocorpMSPanchors.tx --tls true --cafile $ORDERER_CA
    ...
    docker exec -e "CORE_PEER_ADDRESS=peer5.digibank.example.com:8051" -e "CORE_PEER_LOCALMSPID=digibankMSP" -e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/digibank.example.com/users/Admin@digibank.example.com/msp" cli peer channel update -o orderer1.magnetocorp.example.com:7050 -c ${CHANNEL_NAME} -f ./channel-artifacts/digibankMSPanchors.tx --tls true --cafile $ORDERER_CA
fi
